...
const char* fn_mesh = "F:\\C++Codes\\LagrangeDG\\sedov\\output\\mesh.plt";
const char* fn_pre = "F:\\C++Codes\\LagrangeDG\\sedov\\output\\pressure.plt";
const char* fn_interene = "F:\\C++Codes\\LagrangeDG\\sedov\\output\\e.plt";
