...
const int n = 60;    /**< 网格横向剖分大小，0-n*/
const int m = 60;    /**< 网格纵向剖分大小，0-m*/

const double X = 2.2; /**< 计算区域横坐标*/
const double Y = 2.2; /**< 计算区域纵坐标*/

const double hx = X / (double) n;   /**< spatial step in x*/
const double hy = Y / (double) m;   /**< spatial step in y*/

const double T = 0.5;   /**< end time*/

extern double dt;  /**< time step*/

const double c_CFL = 0.1;  /**< CFL条件系数*/

const double ux_alpha = 0.2;
const double uy_alpha = 0.2;
const double tau_alpha = 0.;
