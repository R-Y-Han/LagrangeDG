...
const char* fn_mesh = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\mesh.plt";
const char* fn_pre = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\pressure.plt";
const char* fn_interene = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\e.plt";
const char* fn_ux = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\ux.plt";
...
void plote1d()
{
    int i, j, k;
    double xt, yt, temp;
    const char* fn_e1d = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\e1d.plt";
    remove(fn_e1d);
    ofstream f(fn_e1d);
...
void plotux1d()
{
    int i, j, k;
    double xt, yt, temp;
    const char* fn_ux1d = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\ux1d.plt";
    remove(fn_ux1d);
    ofstream f(fn_ux1d);
...
void plotrho1d()
{
    int i, j, k;
    double xt, yt, temp;
    const char* fn_rho1d = "F:\\C++Code\\LagrangeDG\\saltzman_shock_tube\\output\\rho1d.plt";
    remove(fn_rho1d);
    ofstream f(fn_rho1d);
